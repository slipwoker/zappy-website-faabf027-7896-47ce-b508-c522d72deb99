document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function getErrorMessage(field, rule) {
      const label = field.closest('.form-group')
        ? (field.closest('.form-group').querySelector('label') || {}).textContent || field.name || field.id
        : field.name || field.id;
      ...
      const messages = {
        ...
        minlength: '\u0627\u0644\u062d\u062f \u0627\u0644\u0623\u062f\u0646\u0649 \u0644\u0644\u0623\u062d\u0631\u0641 \u063a\u064a\u0631 \u0645\u0633\u062a\u0648\u0641'
      };
    ...
    function validateField(field) {
      ...
      } else if (field.hasAttribute('minlength') && !VALIDATORS.minlength(field.value, field.getAttribute('minlength'))) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      fetch(action, {
        ...
        .then(function (response) {
          if (response.ok) {
            showFormMessage(contactForm, 'success', '\u062a\u0645 \u0625\u0631\u0633\u0627\u0644 \u0631\u0633\u0627\u0644\u062a\u0643 \u0628\u0646\u062c\u0627\u062d! \u0633\u0646\u062a\u0648\u0627\u0635\u0644 \u0645\u0639\u0643 \u0642\u0631\u064a\u0628\u0627\u064b.');
            contactForm.reset();
            contactForm.querySelectorAll('.field-valid, .field-invalid').forEach(function (f) {
        ...
        .catch(function () {
          showFormMessage(contactForm, 'error', '\u062d\u062f\u062b \u062e\u0637\u0623 \u0623\u062b\u0646\u0627\u0621 \u0627\u0644\u0625\u0631\u0633\u0627\u0644. \u064a\u0631\u062c\u0649 \u0627\u0644\u0645\u062d\u0627\u0648\u0644\u0629 \u0645\u0631\u0629 \u0623\u062e\u0631\u0649.');
        })
        .finally(function () {
          if (submitBtn) {
  ...
  const animationTargets = document.querySelectorAll(animationTargetSelectors.join(', '));

  if (animationTargets.length > 0 && 'IntersectionObserver' in window) {
    ...
    animationTargets.forEach(function (el, index) {
      el.classList.add(OBSERVED_CLASS);

      if (!el.hasAttribute('data-delay') && !el.dataset.animateDelay) {
  ...
  // ─── Counter Animation for Stat Elements ─────────────────────────────────────
  const statNumbers = document.querySelectorAll('[data-count], .stat-number, .counter');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'faabf027-7896-47ce-b508-c522d72deb99',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'faabf027-7896-47ce-b508-c522d72deb99';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'faabf027-7896-47ce-b508-c522d72deb99';
